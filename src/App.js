...
import ListaOrcamentoNao from './Pages/ListaOrcamentoNao/ListaOrcamentoNao.js';
          ...
          <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <Box component="main" sx={{ flex: 1, py: 6, px: 4, bgcolor: '#eaeff1' }}>
              <Routes>
                ...
                {/* <Route path="/pre-budget" element={<Preorcamento  />}/> */}
                ...
                <Route path="/list-notbudget" element={isAuthenticated() ? <ListaOrcamentoNao /> : <Navigate to="/login" />} />
                <Route path="/clients" element={isAuthenticated() ? <Clients /> : <Navigate to="/login" />} />
                
                <Route path="/usuarios" element={isAuthenticated() ? (<PermissionGate allowedRoutes={['administrador']}><Usuarios /></PermissionGate>
                ) : (
                  <Navigate to="/login" />
                )
                }
