...
const categories = [

  {
    id: 'Clientes',
    children: [
      { id: 'Todos Clientes', icon: <PeopleIcon />, route: '/clients' , allowedPermissions: ['administrador', 'usuario', 'observador']},
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'Todos Orçamentos', icon: <NoCrashIcon />, route: '/budget', allowedPermissions: ['administrador', 'usuario', 'observador'] },
      { id: 'Serviços Realizados ', icon: <ThumbUpAltIcon />, route: '/list-budget', allowedPermissions: ['administrador', 'usuario', 'observador'] },
      { id: 'Não Realizados', icon: <ThumbDownAltIcon />, route: '/list-notbudget', allowedPermissions: ['administrador', 'usuario', 'observador'] },
    ],
  },
  {
    id: 'Administrador',
    children: [
      { id: 'Todos Usuários', icon: <Groups2Icon />, route: '/usuarios' , allowedPermissions: ['administrador', 'usuario', 'observador']},
      // { id: 'Logs', icon: <Logger />, route: '/logger' , allowedPermissions: ['administrador']},
    ],
  },
];
